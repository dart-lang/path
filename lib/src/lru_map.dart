...
// copied from the quiver collection
// https://github.com/google/quiver-dart/blob/master/lib/src/collection/lru_map.dart

import 'dart:collection';

import 'generating_iterable.dart';
...
class LinkedLruHashMap<K, V> implements LruMap<K, V> {
  ...
  LinkedLruHashMap._fromMap(this._entries, {int maximumSize})
      ...
      : _maximumSize = firstNonNull(maximumSize, _defaultMaximumSize);
...
int firstNonNull(int o1, int o2) {
